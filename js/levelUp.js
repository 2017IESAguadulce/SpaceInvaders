...
var levelUp = {
    ...
    create: function() {
        ...
        game.titulo = game.add.text(80, 80, 'Mejorar Nave', { font: '54px Arial', fill: 'white' });
		...
		game.btnJugar = game.add.button(game.world.centerX + 100, 300, 'botonJugar', this.manejadorClickBotonJugar, this, 0, 1, 0);
